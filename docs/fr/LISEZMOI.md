...
1. Installez `fuse2` pour votre distribution
2. Téléchargez [LibreScore.AppImage](https://github.com/LibreScore/app-librescore/releases/latest/download/LibreScore.AppImage)
